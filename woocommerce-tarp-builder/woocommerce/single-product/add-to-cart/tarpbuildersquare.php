<?php
/**
* Custom Tarp Builder add to cart for circular tarps.
*
...
<form class="cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
	<fieldset class="wctb-fe-tarpbuilder-options">
		...
		<div class="wctb-fe-dimensions wctb-fe-option-container">
			...
			<div class="wctb-fe-dimensions-label-row flex-row">
				<label for="wctb-fe-length-ft">Length (ft)<span class="wctb-fe-required">*</span></label>
				<label for="wctb-fe-length-in">Length (in)</label>
				<label for="wctb-fe-width-ft">Width (ft)<span class="wctb-fe-required">*</span></label>
				<label for="wctb-fe-width-in">Width (in)</label>
			</div>
			<div class="wctb-fe-dimensions-input-row flex-row">
				<input type="number" value="0" name="wctb-fe-length-ft" min="0" max="100" required>
				<input type="number" value="0" name="wctb-fe-length-in" min="0" max="11">
				<input type="number" value="0" name="wctb-fe-width-ft" min="0" max="100" required>
				<input type="number" value="0" name="wctb-fe-width-in" min="0" max="11">
			</div>
		</div>
		<!-- Hidden inputs -->
		...
		<input type="hidden" name="wctb-fe-grommet-spacing-1" value="0">
		<input type="hidden" name="wctb-fe-grommet-spacing-2" value="0">
		<input type="hidden" name="wctb-fe-grommet-spacing-lengthinches1" value="0">
		<input type="hidden" name="wctb-fe-grommet-spacing-lengthinches2" value="0">
		<input type="hidden" name="wctb-fe-grommet-spacing-widthinches1" value="0">
		<input type="hidden" name="wctb-fe-grommet-spacing-widthinches2" value="0">
	</fieldset>
	<fieldset class="wctb-fe-tarpbuilder-customedge-options hidden">
		...
		<div class="wctb-fe-side-input-labels flex-row">
			<label for="wctb-fe-length-side-1">Length Side 1</label>
			<label for="wctb-fe-length-side-2">Length Side 2</label>
			<label for="wctb-fe-width-side-1">Width Side 1</label>
			<label for="wctb-fe-width-side-2">Width Side 2</label>
		</div>
		<div class="wctb-fe-side-inputs flex-row">
			<input type="number" value="0" name="wctb-fe-length-side-1" min="0" max="100">
			<input type="number" value="0" name="wctb-fe-length-side-2" min="0" max="100">
			<input type="number" value="0" name="wctb-fe-width-side-1" min="0" max="100">
			<input type="number" value="0" name="wctb-fe-width-side-2" min="0" max="100">
		</div>
		...
		<div class="wctb-fe-grommet-spacing-container">
			...
			<span id="wctb-fe-side-1-spacing">Length 1: 0 grommets, 0" apart. | Width 1: 0 grommets, 0" apart.</span>
			<span id="wctb-fe-side-2-spacing">Length 2: 0 grommets, 0" apart. | Width 2: 0 grommets, 0" apart.</span>
		</div>
	</fieldset>
	<section class="wctb-order-summary">
		...
		<div class="wctb-fe-price-container flex-row">
			...
			<span id="wctb-fe-price">$85.00</span>
		</div>
	</section>
